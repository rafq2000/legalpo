          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
            <div className="lg:col-span-2">
              ...
              <div className="prose max-w-none mb-8">
                ...
                <p>
                  En Chile, según estadísticas del Poder Judicial, anualmente se presentan más de 60.000 demandas por
                  pensión de alimentos, lo que refleja la importancia y frecuencia de este tema en nuestra sociedad.
                  Además, con la reciente implementación del Registro Nacional de Deudores de Pensiones de Alimentos en
                  2022, el Estado ha fortalecido los mecanismos para garantizar el cumplimiento de esta obligación.
                </p>

                <h2>Marco legal de la pensión de alimentos</h2>

                <p>
                  El derecho a alimentos y la obligación de proporcionarlos están regulados principalmente por las
                  siguientes normativas:
                </p>

                <ul>
                  <li>
                    <strong>Código Civil (artículos 321 a 337):</strong> Establece quiénes están obligados a
                    proporcionar alimentos, el orden de prelación entre los obligados, y los criterios para determinar
                    el monto.
                  </li>
                  <li>
                ...
                <p>
                  Este marco legal establece que los padres son los primeros obligados a proporcionar alimentos a sus
                  hijos, independientemente de si tienen o no el cuidado personal de ellos. La obligación alimenticia es
                  de orden público, lo que significa que no se puede renunciar a ella y tiene preferencia sobre
                  cualquier otra obligación económica del alimentante.
                </p>
              </div>
                        ...
                        <li className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-muted-foreground">
                              ...
                              juicio. En esta audiencia, el juez puede fijar una pensión provisoria mientras dura el
                              juicio.
                            </p>
                          </div>
                        </li>
                      ...
                      <div className="space-y-4 mt-2">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                          ...
                          <li>
                            ...
                            cada hijo. Este porcentaje puede variar según la cantidad de hijos y las necesidades
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg mt-4">
                          ...
                          <p className="text-sm">
                            ...
                            pasa con cada padre. En estos casos, se considera el principio de corresponsabilidad
                            parental, donde ambos padres contribuyen equitativamente según sus posibilidades.
                          </p>
                        </div>
                      </div>
                    </CardContent>
                      ...
                      <div className="space-y-4 mt-2">
                        ...
                        <div className="space-y-4 mt-4">
                          ...
                          <div className="bg-purple-50 p-4 rounded-lg">
                            ...
                            <ol className="list-decimal pl-5 space-y-1">
                              <li>
                                Solicitar liquidación de deuda ante el tribunal (se calcula el monto total adeudado)
                              </li>
                              ...
                              <li>
                                Solicitar retención de remuneraciones directamente al empleador (hasta el 50% del
                                sueldo)
                              </li>
                        ...
                        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mt-4">
                          ...
                          <p className="text-sm">
                            ...
                            al deudor. Este beneficio se solicita a través del tribunal que dictó la sentencia de
                            alimentos y está sujeto a ciertos requisitos.
                          </p>
                        </div>
                      </div>
                    </CardContent>
              ...
              <div className="prose max-w-none mt-8 mb-8">
                ...
                <p>
                  Una vez presentada la demanda, el tribunal verifica que cumpla con los requisitos legales y la admite
                  a tramitación. Luego, ordena notificar al demandado, quien tendrá un plazo para contestar la demanda.
                  La notificación debe ser personal, lo que a veces puede complicar el proceso si el demandado es
                  difícil de ubicar.
                </p>

                <h3>Audiencia preparatoria</h3>

                <p>En esta audiencia, que es obligatoria para ambas partes, el juez:</p>
                ...
                <p>
                  Si el demandado no asiste a esta audiencia sin causa justificada, el juez puede presumir que acepta
                  los hechos expuestos en la demanda.
                </p>

                <h3>Audiencia de juicio</h3>

                <p>En esta audiencia:</p>
                ...
                <p>
                  La sentencia establece el monto de la pensión, la forma de pago, la fecha de inicio del pago y
                  cualquier otra medida necesaria para asegurar su cumplimiento.
                </p>

                <h3>Recursos</h3>

                <p>
                  La sentencia puede ser apelada dentro de los 10 días siguientes a su notificación. La apelación se
                  presenta ante el mismo tribunal que dictó la sentencia y es resuelta por la Corte de Apelaciones
                  correspondiente.
                </p>
                ...
                <p>
                  Una vez firme la sentencia, el tribunal ordena su cumplimiento. Si el alimentante no paga
                  voluntariamente, se pueden solicitar medidas de apremio como las mencionadas anteriormente.
                </p>

                <h2>Modificación y cese de la pensión de alimentos</h2>

                <p>
                  La pensión de alimentos no es inmutable y puede ser modificada cuando cambian las circunstancias que
                  se tuvieron en cuenta al fijarla.
                </p>

                <h3>Aumento de pensión</h3>

                <p>Se puede solicitar un aumento de la pensión cuando:</p>
                ...
                <p>El alimentante puede solicitar una rebaja de la pensión cuando:</p>
                ...
                <p>La obligación de pagar pensión de alimentos cesa cuando:</p>
                ...
                <p>
                  En el caso de hijos con discapacidad que les impida valerse por sí mismos, la pensión puede ser
                  vitalicia.
                </p>
                ...
                <p>
                  Para modificar la pensión, se debe presentar una demanda de aumento o rebaja ante el mismo tribunal
                  que fijó la pensión original. El procedimiento es similar al de la demanda inicial.
                </p>
              </div>
            </div>
                ...
                <Card className="mb-6">
                  ...
                  <CardContent>
                    <ul className="space-y-2">
                      <li>
                        <Link href="/herencias" className="text-blue-600 hover:underline flex items-center">
                      ...
                      <li>
                        <Link href="/consulta-familia" className="text-blue-600 hover:underline flex items-center">
                          <FileText className="h-4 w-4 mr-2" />
                          Consultas sobre derecho familiar
                        </Link>
                      </li>
                    </ul>
                  </CardContent>
                ...
                <Card className="bg-blue-50 border-blue-100 mb-6">
                  ...
                  <CardContent>
                    <p className="text-sm mb-4">
                      Si tienes dudas específicas sobre tu caso de pensión de alimentos, nuestros abogados pueden
                      orientarte.
                    </p>
