      ...
      <Card className="max-w-4xl mx-auto shadow-lg border-blue-100">
        ...
        <CardContent className="p-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="resultado" className="space-y-6">
              {resultado && (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-5 bg-blue-50 rounded-lg">
                    <div className="text-center p-3 bg-white rounded-lg shadow-sm">
                      <p className="text-sm text-blue-700 font-medium">Tiempo de servicio</p>
                      <p className="font-semibold text-blue-900 mt-1">{resultado.tiempoServicio}</p>
                    </div>
                    <div className="text-center p-3 bg-white rounded-lg shadow-sm">
                      <p className="text-sm text-blue-700 font-medium">Sueldo mensual</p>
                      <p className="font-semibold text-blue-900 mt-1">{formatMoney(resultado.sueldoMensual)}</p>
                    </div>
                    <div className="text-center p-3 bg-white rounded-lg shadow-sm">
                      <p className="text-sm text-blue-700 font-medium">Causal</p>
                      <p className="font-semibold text-blue-900 mt-1">{getCausalText(formData.causalTermino)}</p>
                    </div>
                  </div>

                  <div className="text-center p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg shadow-sm border border-blue-200">
                    <p className="text-blue-700 font-medium">Total finiquito</p>
                    <p className="text-4xl font-bold text-blue-900 mt-2">{formatMoney(resultado.total)}</p>
                  ...
                  <div className="space-y-3">
                    <h3 className="text-lg font-semibold text-blue-900 mb-3">Desglose del finiquito</h3>

                    <div className="border border-blue-100 rounded-lg overflow-hidden bg-white">
                      <div
                        className="flex justify-between p-4 cursor-pointer hover:bg-blue-50 transition-colors"
                      ...
                      >
                        ...
                        <div className="flex items-center">
                          <div className="font-semibold text-blue-900 mr-3">
                      ...
                      {expandedDetails.includes("remuneraciones") && (
                        <div className="p-4 bg-blue-50 border-t border-blue-100">
                          <p className="text-sm text-blue-700 mb-2">
                            Corresponde al salario de los días trabajados que aún no han sido pagados.
                          </p>
                          <div className="text-sm font-mono bg-white p-3 rounded border border-blue-100">
                            {resultado.formulas.remuneraciones}
                          </div>
                        </div>
                      )}
                    </div>

                    {formData.causalTermino === "art161" && (
                      <>
                        <div className="border border-blue-100 rounded-lg overflow-hidden bg-white">
                          <div
                            className="flex justify-between p-4 cursor-pointer hover:bg-blue-50 transition-colors"
                          ...
                          {expandedDetails.includes("indemnizacionAviso") && (
                            <div className="p-4 bg-blue-50 border-t border-blue-100">
                              <p className="text-sm text-blue-700 mb-2">
                                Corresponde a un mes de sueldo cuando no se da aviso previo con 30 días de anticipación.
                              </p>
                              <div className="text-sm font-mono bg-white p-3 rounded border border-blue-100">
                                {resultado.formulas.indemnizacionAviso}
                              </div>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="border border-blue-100 rounded-lg overflow-hidden bg-white">
                          ...
                          {expandedDetails.includes("indemnizacionAnos") && (
                            <div className="p-4 bg-blue-50 border-t border-blue-100">
                              <p className="text-sm text-blue-700 mb-2">
                                Corresponde a un mes de sueldo por cada año de servicio y fracción superior a 6 meses.
                              </p>
                              <div className="text-sm font-mono bg-white p-3 rounded border border-blue-100">
                                {resultado.formulas.indemnizacionAnos}
                              </div>
                            </div>
                          )}
                        </div>
                    ...
                    <div className="border border-blue-100 rounded-lg overflow-hidden bg-white">
                      ...
                      {expandedDetails.includes("vacaciones") && (
                        <div className="p-4 bg-blue-50 border-t border-blue-100">
                          <p className="text-sm text-blue-700 mb-2">
                            Corresponde a los días de vacaciones generados pero no utilizados.
                          </p>
                          <div className="text-sm font-mono bg-white p-3 rounded border border-blue-100">
                            {resultado.formulas.vacaciones}
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    {resultado.feriadoProporcional > 0 && (
                      <div className="border border-blue-100 rounded-lg overflow-hidden bg-white">
                        ...
                        {expandedDetails.includes("feriado") && (
                          <div className="p-4 bg-blue-50 border-t border-blue-100">
                            <p className="text-sm text-blue-700 mb-2">
                              Corresponde a los días de feriado proporcional al tiempo trabajado desde el último año.
                            </p>
                            <div className="text-sm font-mono bg-white p-3 rounded border border-blue-100">
                              {resultado.formulas.feriado}
                            </div>
                          </div>
                        )}
                      </div>
                    ...
                    {resultado.gratificacionesProporcionales > 0 && (
                      <div className="border border-blue-100 rounded-lg overflow-hidden bg-white">
                        ...
                        >
                          <div className="font-medium text-blue-800 flex items-center">
                            <DollarSign className="h-4 w-4 mr-2 text-blue-600" />
                            Proporcional de gratificaciones
                          </div>
                          <div className="flex items-center">
                            <div className="font-semibold text-blue-900 mr-3">
                        ...
                        {expandedDetails.includes("gratificaciones") && (
                          <div className="p-4 bg-blue-50 border-t border-blue-100">
                            <p className="text-sm text-blue-700 mb-2">
                              Corresponde a la parte proporcional de las gratificaciones devengadas pero no pagadas.
                            </p>
                            <div className="text-sm font-mono bg-white p-3 rounded border border-blue-100">
                              {resultado.formulas.gratificaciones}
                            </div>
                          </div>
                        )}
                      </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-blue-800 text-sm">
                        Esta calculadora es solo referencial. Para casos específicos, se recomienda consultar con un
                        especialista en derecho laboral.
                      </p>
                      <p className="text-blue-700 text-sm mt-2">
                        ¿Necesitas ayuda con tu finiquito?{" "}
                        <a href="/dudas-laborales" className="text-blue-600 underline">
        ...
        <CardFooter className="bg-gradient-to-r from-blue-50 to-blue-100 border-t border-blue-100 p-4 text-center">
          <p className="text-sm text-blue-700 w-full">
            © 2025 DocuScan AI - Calculadora basada en la legislación laboral chilena vigente
          </p>
        </CardFooter>
      </Card>
