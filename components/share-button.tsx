...
export function ShareButton({
  ...
  const shareOnInstagram = () => {
    // Instagram no tiene una API directa para compartir, pero podemos abrir la app
    // y el usuario puede copiar y pegar el contenido
    if (/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)) {
      ...
      setTimeout(() => {
        ...
        toast({
          ...
          description: "El contenido ha sido copiado al portapapeles para compartir en Instagram",
        })
      }, 500)
    } else {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={shareOnInstagram}>
            <svg className="h-4 w-4 mr-2" viewBox="0 0 24 24" fill="#E4405F">
