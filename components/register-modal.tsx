...
export function RegisterModal({ open, onClose, onRegister }: RegisterModalProps) {
  return (
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogTitle className="text-center text-xl font-semibold mt-4">Crea tu cuenta gratuita</DialogTitle>
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-2">
          <Button asChild className="w-full" onClick={onRegister}>
