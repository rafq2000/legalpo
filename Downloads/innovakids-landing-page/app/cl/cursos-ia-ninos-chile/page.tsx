...
export const metadata: Metadata = {
  ...
  keywords:
    "cursos de ia para niños chile, clases inteligencia artificial santiago, curso ia niños viña del mar, programación ia niños concepción, innovakids chile",
  alternates: {
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="mx-auto max-w-md rounded-3xl bg-gradient-to-br from-[#0039A6] to-[#001d53] p-8 text-white shadow-2xl">
              ...
              <div className="mb-6">
                ...
                <p className="mt-2 text-[#D52B1E] font-medium">Ahorra $200 USD</p>
              </div>
              ...
              <Link
                href={calendlyLink}
                target="_blank"
                className="mb-4 block w-full rounded-full bg-[#D52B1E] py-4 text-center text-lg font-bold text-white transition-all hover:scale-105 hover:shadow-lg"
              >
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <p className="text-[#D52B1E] font-medium mb-1">Early Bird: Primeros 10 inscritos</p>
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 text-muted-foreground">
                <span className="rounded-lg bg-card px-4 py-2">💳 Tarjeta crédito/débito</span>
