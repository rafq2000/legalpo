...
export const metadata: Metadata = {
  ...
  description:
    "✅ Cursos de Inteligencia Artificial para cipotes salvadoreños de 8-17 años. Clases online en vivo, grupos de máx 5 alumnos. $200 USD por 10 clases. ¡Garantía 10 días!",
  keywords:
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-[#0F47AF]/10 border border-[#0F47AF]/20 rounded-2xl p-6 max-w-xl mx-auto">
                <p className="text-lg font-semibold text-[#0F47AF]">💰 Inversión: $200 USD</p>
