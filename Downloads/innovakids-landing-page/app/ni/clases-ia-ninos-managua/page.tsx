...
export const metadata: Metadata = {
    title: "Clases de IA para Niños en Managua 2026 | InnovaKids 🇳🇮",
    description:
        "Clases de inteligencia artificial para niños en Managua. Online en vivo, grupos de 5 alumnos. Horarios flexibles.",
    keywords: ["clases ia niños managua", "cursos inteligencia artificial managua", "ia niños nicaragua"],
                ...
                <section className="pt-32 pb-24 bg-gradient-to-b from-background to-[#0a1628]">
                    <div className="container mx-auto px-6 max-w-5xl text-center">
                        <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6 font-premium">
                            Clases de IA <span className="text-primary">en Managua</span>
                        </h1>
