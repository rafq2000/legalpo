...
export const metadata: Metadata = {
  ...
  description:
    "Cursos de Inteligencia Artificial para patojos en Guatemala. Clases online en vivo desde Guatemala City, Quetzaltenango, Mixco y todo el país. $200 USD - 10 clases.",
  alternates: {
