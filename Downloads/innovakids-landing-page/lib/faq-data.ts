export const faqs = [
    ...
    },
    {
        ...
        answer:
            "$197 USD (precio de lanzamiento Vibe Edition 2026). Este es un precio especial para los primeros cupos del año. Incluye: 10 clases en vivo, certificación, materiales, acceso de por vida a grabaciones, y garantía de 10 días. Facilidades: Pago con tarjeta, PayPal, Mercado Pago.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "Si los cupos se llenan, abriremos lista de espera para futuros grupos. En la evaluación te informaremos disponibilidad exacta y próximas fechas. Recomendación: Asegura el cupo HOY.",
    },
    {
