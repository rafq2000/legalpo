...
CREATE UNIQUE INDEX IF NOT EXISTS unique_normalized_query ON response_cache (normalized_query);
...
COMMENT ON COLUMN response_cache.normalized_query IS 'Consulta normalizada (minúsculas, sin espacios extra)';
